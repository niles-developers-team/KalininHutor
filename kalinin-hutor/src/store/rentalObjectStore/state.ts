...
import { ModelLoadingState, ModelLoadedState, ModelsLoadingState, ModelsLoadedState, ModelsDeletingState, ModelsDeletedState, ModelSpecsLoadingState, ModelSpecsLoadedState } from "../appState";
...
export type RentalObjectState = RentalObjectModelState & RentalObjectModelSpecsState & RentalObjectModelsState & RentalObjectDeleteState;